          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Matriculas: 1 enero, 2018 - 31 enero, 2019</strong>
                  </p>
                ...
                <div class="col-md-4">
                  <p class="text-center">
                    <strong> Rendimiento Por Asignaturas</strong>
                  </p>

                  <div class="progress-group">
                    <span class="progress-text">Matematica</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Lengua y literatura</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Ingles</span>
