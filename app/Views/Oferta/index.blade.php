...
<?=  $this -> section ( 'contenido' )  ?>   <!--agrega codigo a la seccion contenido del layout-->        
            ...
            <div class="box-header">
              ...
              <div class="pull-right box-tools">
                <a href="#" data-toggle="modal" data-target="#crear_oferta" id="cargar" class="btn btn-warning btn-sm pull-right" >Agregar Oferta</a> 
            ...
            <!-- Boton Nuevo--> 
               ...
               <button class="btn btn-info" onclick='' data-id="<?php echo $oferta['id']; ?>" data-Nombre="<?php echo $oferta['Descripcion'];?>" ><i class="fa fa-fw fa-trash "></i></button>  <!--botton para eliminar-->                            
